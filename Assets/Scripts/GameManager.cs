...
{
    public static int p1_esmeraldas;
    public static int p1_zafiros;
    public static int p1_rubis;
    public static int p1_oro;
    public static int p2_esmeraldas;
    public static int p2_zafiros;
    public static int p2_rubis;
